          	...
          	<table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
          		<tr>
          			<td width="40%" class="logo" style="text-align: left;">
			            <h1><a href="#">{{config('beery.title')}}</a></h1>
			          </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-right: 10px;">
                      	...
                      	<p>&nbsp;</p>
                      	<ul class="social">
                      		<li><img src="<?=asset('templates/colorlibhq/images/002-play-button.png')?>" alt="" style="width: 30px; max-width: 600px; height: auto; display: block;"></li>
                      		<li><img src="<?=asset('templates/colorlibhq/images/002-play-button.png')?>" alt="" style="width: 30px; max-width: 600px; height: auto; display: block;"></li>
                      		<li><img src="<?=asset('templates/colorlibhq/images/002-play-button.png')?>" alt="" style="width: 30px; max-width: 600px; height: auto; display: block;"></li>
                      	</ul>
                      </td>
                  ...
                  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                      <td style="text-align: left; padding-left: 5px; padding-right: 5px;">
                      	...
                      	<ul>
                            <li><span class="text">{{config('beery.address')}}, {{config('beery.city')}}, {{config('beery.country')}}</span></li>
                            <li><span class="text">{{config('beery.phone')}}</span></a></li>
                        </ul>
                      </td>
                    </tr>
                  </table>
